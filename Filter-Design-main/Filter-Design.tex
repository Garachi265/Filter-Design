...
\title{Filter Design}
\author{EE23BTECH11206 - Chirag Garg}
...
\begin{lstlisting}
    https://github.com/Garachi265/Filter-Design/blob/main/codes/pole_zero.py
\end{lstlisting}
\begin{figure}[h!]
    \centering
...
\begin{lstlisting}
    https://github.com/Garachi265/Filter-Design/blob/main/codes/poles.txt
\end{lstlisting}
...
\begin{lstlisting}
    https://github.com/Garachi265/Filter-Design/blob/main/codes/coeff_analog.py
\end{lstlisting}
And the coefficients are stored into the .txt file,
\begin{lstlisting}
    https://github.com/Garachi265/Filter-Design/blob/main/codes/coefficients_analog.txt
\end{lstlisting}
...
\begin{lstlisting}
    https://github.com/Garachi265/Filter-Design/blob/main/codes/coeff_digital.py
\end{lstlisting}
And the the coefficients are then stored in this .txt file,
\begin{lstlisting}
    https://github.com/Garachi265/Filter-Design/blob/main/codes/coefficients_digital.txt
\end{lstlisting}
